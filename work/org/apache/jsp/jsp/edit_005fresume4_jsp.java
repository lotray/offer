...
public final class edit_005fresume4_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<input size='16' type='text' value='' class='date-control form-control' style=\"width: 75% !important;\" readonly name='jobstart' id='jobstart'>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class='input-append date form_datetime2'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input size='16' type='text' value='' class='date-control form-control' style=\"width: 75% !important;\" readonly name='jobend' id='jobend'>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <span class='add-on'><i class='icon-th'></i></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"textR\" width=\"80px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"toNow1\" name=\"toNow1\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" id=\"toNowWork\" name=\"toNowWork\" /><font color=\"#4F4F4F\" style=\"font-size:16px;\" >至今</font>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td/>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t<td/>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t\t\t\t<textarea rows=\"8\" style=\"width:75%;min-width:300px;\" id=\"workcontent\" name=\"workcontent\"></textarea>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
